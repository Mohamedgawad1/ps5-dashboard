...
const doneI=s=>/complete/i.test(s)||s==='Closed';
...
def main():
    ...
    state['cells'] = cap.get('cells', {})
    n_cells = sum(len(v) for v in state['cells'].values())
